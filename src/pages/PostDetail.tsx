...
const PostDetail = () => {
  ...
  const processRawComment = async (comment: RawHivePost, authorReputationMap: Map<string, { formatted: number, raw: number }>): Promise<Comment> => {
    ...
    return {
      ...
      pending_payout_value: comment.pending_payout_value || '0.000 HBD',
      total_payout_value: comment.total_payout_value || '0.000 HBD',
      curator_payout_value: comment.curator_payout_value || '0.000 HBD',
